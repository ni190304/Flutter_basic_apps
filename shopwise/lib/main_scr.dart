    ...
    return Scaffold(
        ...
        body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          stream: FirebaseFirestore.instance
              ...
              .doc(user_email)
              .snapshots(),
          builder: (context, businessnapshot) {
            return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, customersnapshot) {
                if (businessnapshot.connectionState == ConnectionState.active &&
                    businessnapshot.hasData &&
                    businessnapshot.data!.exists) {
                  return BusinessScreen();
                } else if (customersnapshot.connectionState ==
